  ...
  return (
    <section className="luxury-hero">
      ...
      <div className="luxury-hero-bg">
        <img
          src="https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&w=2200&q=85"
          alt="Luxury Himalayan destination in Nepal"
        />
      </div>
            ...
            <div className="luxury-search">
              ...
              <div className="search-field travelers-field">
                ...
                <button
                  ...
                  onClick={() => setTravelerOpen((current) => !current)}
                >
